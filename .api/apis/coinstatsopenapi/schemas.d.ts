        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                ...
                readonly from: {
                    ...
                    readonly type: "string";
                    readonly examples: readonly ["2025-01-07T11:09:23.142Z"];
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                ...
                readonly to: {
                    readonly format: "date-time";
                    readonly type: "string";
                    readonly examples: readonly ["2025-01-08T13:09:23.143Z"];
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "Please include the date in ISO 8601 format";
                };
                readonly currency: {
        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                ...
                readonly from: {
                    readonly format: "date-time";
                    readonly type: "string";
                    readonly examples: readonly ["2025-01-07T11:09:23.150Z"];
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "Please include the date in ISO 8601 format";
                };
                readonly to: {
                    readonly format: "date-time";
                    readonly type: "string";
                    readonly examples: readonly ["2025-01-08T13:09:23.151Z"];
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "Please include the date in ISO 8601 format";
                };
            };
