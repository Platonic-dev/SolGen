...
var SDK = /** @class */ (function () {
     ...
     *
     */
    SDK.prototype.walletChart = function (metadata) {
     ...
     *
     */
    SDK.prototype.getExchangeChart = function (metadata) {
        return this.core.fetch('/exchange/chart', 'get', metadata);
    };
    /**
     * <b> 20 credits per request </b>
     *             <hr>
     *         This endpoint allows you to sync exchange</hr>
     *
     */
    SDK.prototype.exchangeSyncStatus = function (metadata) {
     ...
     * other data displayed on CoinStats web.
     *  *Note that only Degen plan users’ shareToken’s data can be viewed via API.</hr>
     *
     */
     ...
     * displayed on the CoinStats website.
     *  *Note that only Degen plan users’ shareToken’s data can be viewed via API.</hr>
     *
     */
     ...
     * <b> 4 credits per request </b>
     *             <hr>
     *         This endpoint allows you to retrieve a list of portfolio Transactions.
     *  *Note that only Degen plan users’ shareToken’s data can be viewed via API.</hr>
     *
     */
     ...
     * <b> 4 credits per request </b>
     *             <hr>
     *         This endpoint allows you to add a transaction to a manual portfolio.
     *  *Note that only Degen plan users’ shareToken’s data can be viewed via API.</hr>
     *
     */
